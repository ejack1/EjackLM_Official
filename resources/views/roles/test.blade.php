...
<table id="example" class="display" class="table" style="width:100%">
    <thead>
    ...
    $(document).ready(function () {
        $('#example').DataTable({
            ...
            "buttons": [
                ...
                {
                    extend: 'excel',
                    className: 'button w-24 mr-1 mb-2 bg-theme-12 text-white',
                ...
                {
                    extend: 'csv',
                    className: 'button w-24 mr-1 mb-2 bg-theme-9 text-white',
