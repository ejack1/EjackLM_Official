...
@section('title')
    <title>Deleted Shipments</title>
@endsection

@section('content')
<h1 style="text-align: center; font-size:2.4rem; padding-top:20px" >Deleted Shipments</h1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 5px;">
                    ...
                    <a href="{{ url('shipment_delete_restore',$t->id) }}">  
                        <i class="fas fa-trash-restore"></i>
                    </a>

                    <a href="{{ url('shipment_delete_permanent',$t->id) }}">  
                        <i class="fas fa-ban">Permanent</i>
                    </a>
